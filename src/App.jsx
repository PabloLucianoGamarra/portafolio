...
const projects = [
  {
    ...
    description:
      'Una tienda de objetos cotidianos, con un catálogo simple y una experiencia de compra clara.',
    details:
      'Demo creada para este portafolio. Incluye filtro por categoría y carrito local, con productos ficticios. No procesa pedidos ni pagos.',
  },
  {
    id: 'empresa',
    ...
    description:
      'Una propuesta de identidad digital para un estudio: servicios, espacios y una presentación con personalidad.',
    details:
      'Concepto visual para una marca ficticia, creado para mostrar una posible dirección de diseño. No corresponde a un cliente ni a un sitio publicado.',
  },
  {
    id: 'notas',
    ...
    description:
      'Sistema de gestión académica desarrollado con Laravel: calificaciones, usuarios y materias en un mismo lugar.',
    details:
      'Proyecto propio en Laravel. Las capturas muestran el seguimiento de notas trimestrales y finales, la administración de usuarios por rol y la gestión de materias con filtros por ciclo lectivo.',
  },
]
const products = [
  {
  ...
  return (
    <div className="grades-gallery">
      ...
      <div
        ...
        role="group"
        aria-label="Elegir captura del sistema"
      >
        {gradeScreenshots.map((item, index) => (
          <button
            type="button"
            key={item.src}
            aria-pressed={index === selected}
            onClick={() => setSelected(index)}
            aria-controls="grade-screenshot"
          >
            {index + 1}. {item.title}
          </button>
        ))}
...
function ProjectProcess() {
  return (
    <div className="process">
      ...
      <ol>
        <li>
          <h4>Contame qué necesitás</h4>
          <p>
            Tu negocio, tu idea y las referencias que te gustan. No hace falta
            tener todo definido.
          </p>
        </li>
        <li>
          <h4>Definimos el alcance</h4>
          <p>
            Conversamos sobre funcionalidades, prioridades y presupuesto para
            ordenar la propuesta.
          </p>
        </li>
        <li>
          <h4>Acordamos cómo avanzar</h4>
          <p>
            Establecemos las etapas y los próximos pasos antes de empezar el
            desarrollo.
          </p>
        </li>
      </ol>
    ...
    <>
      ...
      <main id="contenido">
        <section id="inicio" className="hero wrap">
          <div className="hero-copy">
            ...
            <p className="hero-description">
              Soy Pablo Luciano Gamarra. Creo tiendas online, páginas
              corporativas y soluciones web a medida para las necesidades de tu
              negocio.
            </p>
        ...
        <section id="proyectos" className="section wrap">
          <div className="section-heading">
            ...
            <p>
              Conceptos de tiendas online, webs corporativas y aplicaciones.
              Explorá cada tarjeta para conocer su alcance y las tecnologías
              utilizadas.
            </p>
          </div>
                ...
                >
                  <div className="project-details-clip">
                    <div className="project-details-content">
                      ...
                      {project.id === 'notas' && <GradesGallery />}
                    </div>
                  </div>
                </div>
              </article>
          ...
          <div className="wrap section">
            ...
            <div className="service-grid">
              <article>
                ...
                <p>
                  Una propuesta para presentar tu catálogo y diseñar una
                  experiencia de compra clara, desde el producto hasta el
                  carrito.
                </p>
              ...
              <article>
                ...
                <p>
                  ...
                  adecuadas según los objetivos, el presupuesto y el alcance de
                  tu proyecto.
                </p>
        ...
        <section id="perfil" className="section wrap profile">
          ...
          <div className="profile-story">
            <p className="profile-lead">
              Desarrollo soluciones digitales y comparto lo que sé a través de
              la enseñanza.
            </p>
            <p>
            ...
            <p>
              He trabajado en la creación de sitios web profesionales,
              plataformas educativas, aulas virtuales y sistemas personalizados.
              También cuento con experiencia enseñando programación y tecnología
              en los niveles secundario y terciario.
            </p>
            <p>
              En cada proyecto busco una solución creativa, funcional y de
              calidad. Me interesa entender lo que necesitás, mantener una
              comunicación clara y acompañar el trabajo con compromiso, desde la
              primera idea hasta su implementación.
            </p>
      ...
      <footer className="footer wrap">
        <a href="#inicio" className="brand">
          pablo<span>gamarra</span>
          <span className="brand-dot">.</span>
        </a>
        <span>Desarrollo web freelance · Soluciones a medida</span>
