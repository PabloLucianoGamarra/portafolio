    ...
    <section id="inicio" className="hero wrap" aria-labelledby="hero-title">
      <div className="hero-copy">
        ...
        <p className="hero-description">
          Desarrollador web, futuro Ingeniero en Informática y profesor de
          programación. Creo sitios, tiendas y plataformas educativas con React,
          Laravel y MySQL.
        </p>
      ...
      <figure className="hero-portrait">
        ...
        <figcaption className="portrait-caption">
          Desarrollo web freelance <span>Argentina</span>
        </figcaption>
      </figure>
    </section>
  )
